...
class FruitSeller6 {
	...
	클래스 내부에서만 접근할수 있고 외부에서의 접근은 원천적으로
	차단할 수 있다. */
	int numOfApple;
	int myMoney;
...
public class E03InfomationHiding {
	...
	public static void main(String[] args) {
		...
		/* 멤버변수를 private으로 선언하면클래스 외부에서는
		접근이 불가능하므로 아래 코드는 에러가 발생하게된다.(이 부분은
		주석으로 처리한다.)
		즉, 멤버변수의 정보은닉을통해 비정상적인 접근을 차단하고
		멤버베서드를 통해서만 구매가 이루어질 수 있도록 구현해야한다. 
		*/
		
		//각 판매자에게 1000원을 지불한다.
		//단가가 1000원으로 1개 구매할 수 있다.
