...
public class E05Date {
	...
	public static void main(String[] args) {
		...
		만약 음수를 주면 과거긔 날짜를 구할 수 있다. */
		calendar.add(Calendar.DATE, 3); //3일
	...
	public static long myDiffDate(String today, String future) {
		...
		try { 
			...
			3자리를 제거하면 순수한 초가 반환된다. 나눠서 뒤의 3자리를 제거하면 순수한 
			초가 반환된다. 또한 하루는 60*60*24 즉 84600초 이므로 아래와 같이
			남은 날짜를 구할 수 있다. */
