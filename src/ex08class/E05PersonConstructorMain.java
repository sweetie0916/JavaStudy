...
public class E05PersonConstructorMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("[멤버벼눗 초기화용 메소드 호출전]");
		person1.showPersonInfo();
		//기존에 생성된 person1을 초기화 메서드를 통해 값을 변경한다.
		System.out.println("[멤버변수 초기화용 메소두 호출후]");
		...
		System.out.println("[이름과 나이만 전달한 값을 초기화하기]");
		PersonConstructor person3 = new PersonConstructor("최길동", 40);
		person3.showPersonInfo();

		System.out.println("[모든 배개변수를 전달한 값으로 초기화하기]");
