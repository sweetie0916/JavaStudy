...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		char형 : 하나의 문자를 저장할 수 있는 자료형으로 값을
			저장할때 '(Single quatation)으로 감싸서 표현한다.
			만약 "(Double quotaition)으로 감싸면 문자열로 인식
			하므로 String으로 선언해야한다.
		*/
		char ch1 = '가';
		...
		*/
		...
		/*
		boolean타입 : true 혹은 flase 두가지의 값만 가질 수 있는
			자료형으로 산술연산(+,-), 비교연산(<,<=)에서는
