...
/* 위 클래스를 상솏하면 부모가 가진 추상메서드를 그대로 상속받게
외므로 해당 클래스도 abstract로 선언해야한다. 단, 이 경우 해당
클래스로도 인스턴슬르 생성할 수 없게된다. 따라서 객체생성을 위해서는
부모의 추상메서드를 자식쪽에서 오버라이딩 하면 된다. */
...
public class E01AbstractMain {
	...
	public static void main(String[] args) {
		...
		될 수 없으므로 static의 기본규칙을 따른다. 별도의 생성 절차없이
		클래스명으로 바로 접근할 수 있다. */
